@extends('layouts.app')
@section('title', 'Historial Global')
...
<style>
    ...
    .btn-detalle { display:inline-flex; align-items:center; gap:.35rem; padding:.4rem .85rem; border-radius:.5rem; font-size:.78rem; font-weight:700; text-decoration:none; transition:all .2s; background:rgba(0,195,255,.1); color:var(--cyan); border:1px solid rgba(0,195,255,.2); }
...
<div class="cj-page">
    <aside class="cj-sidebar">
        ...
        <nav class="sidebar-nav">
            @if($rol === 'admin')
                ...
                <a href="{{ route('admin.historial') }}" class="active">
            ...
            @else
                ...
                <a href="{{ route('ingeniero.contrataciones') }}">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                    Contrataciones
                </a>
                <a href="{{ route('ingeniero.historial') }}" class="active">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                    Historial
                </a>
            @endif
    ...
    <main class="cj-main">
        ...
        <div class="page-header">
            <h1 class="page-title">Historial <span>Global</span></h1>
            @if($rol === 'admin')
                    ...
                    <tbody>
                        @foreach($contrataciones as $c)
                            <tr>
                                ...
                                <td>{{ $c->cliente->nombres }} {{ $c->cliente->apellido_p }}</td>
                                ...
                                <td>
                                    @if($rol === 'admin')
                                        <a href="{{ route('admin.historial.detalle', $c->id_contratacion) }}" class="btn-detalle">
                                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                            Ver detalle
                                        </a>
                                    @else
                                        <a href="{{ route('ingeniero.historial.detalle', $c->id_contratacion) }}" class="btn-detalle">
                                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                            Ver detalle
                                        </a>
                                    @endif
