...
<div class="cj-page">
    <aside class="cj-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @else
                ...
                <a href="{{ route('trabajador.historial') }}" class="active">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                    Historial
                </a>
                <div class="sidebar-divider"></div>
    ...
    <main class="cj-main">
        ...
        <div class="page-header">
            <h1 class="page-title">
                {{ $rol === 'cliente' ? 'Mi' : 'Mis' }} <span>{{ $rol === 'cliente' ? 'Historial' : 'Trabajos' }}</span>
            </h1>
            @if($rol === 'cliente')
                    ...
                    <tbody>
                        @foreach($contrataciones as $c)
                            <tr>
                                ...
                                <td>
                                    @if($rol === 'cliente')
                                        <a href="{{ route('cliente.historial.detalle', $c->id_contratacion) }}" class="btn-detalle">
                                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                            Ver detalle
                                        </a>
                                    @else
                                        <a href="{{ route('trabajador.historial.detalle', $c->id_contratacion) }}" class="btn-detalle">
                                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                            Ver detalle
                                        </a>
                                    @endif
