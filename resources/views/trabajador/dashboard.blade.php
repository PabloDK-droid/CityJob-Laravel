...
<style>
    ...
    .btn-outline:hover { border-color:var(--cyan); color:var(--cyan); background:rgba(0,195,255,.05); }
...
<div class="cj-page">
    ...
    <main class="cj-main">
        ...
        <div class="hero-card">
            ...
            <div class="hero-text">
                <div class="rating-badge">
                    ★ {{ number_format($profesionista->calificacion_profesionista, 1) }} calificación
                </div>
                <div class="hero-greeting">
                    Hola, <span>{{ $profesionista->nombres }}</span>
                </div>
                <p class="hero-desc">
                    Gestiona tus peticiones, servicios asignados y mantén tu perfil actualizado para recibir más solicitudes.
                </p>
                <div class="hero-btns">
                    <a href="{{ route('trabajador.peticionesPendientes') }}" class="btn-cyan">Ver Peticiones</a>
                    <a href="{{ route('trabajador.serviciosAsignados') }}" class="btn-outline">Mis Servicios</a>
                    <a href="{{ route('trabajador.historial') }}" class="btn-outline">Historial</a>
                </div>
            </div>
        </div>
        ...
        <div class="quick-grid">
            <a href="{{ route('trabajador.peticionesPendientes') }}" class="quick-card">
                ...
                <div class="quick-label">Peticiones</div>
                <div class="quick-sub">Solicitudes nuevas esperando respuesta</div>
            </a>

            <a href="{{ route('trabajador.serviciosAsignados') }}" class="quick-card">
                <div class="quick-icon">
            ...
            <a href="{{ route('trabajador.historial') }}" class="quick-card">
                ...
                <div class="quick-sub">Registro de todos tus trabajos</div>
            </a>

            <a href="{{ route('trabajador.editarPerfil') }}" class="quick-card">
                <div class="quick-icon">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                </div>
                <div class="quick-label">Mi Perfil</div>
                <div class="quick-sub">Actualiza tus datos y especialidad</div>
            </a>
