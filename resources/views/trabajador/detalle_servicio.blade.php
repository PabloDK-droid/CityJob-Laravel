...
<style>
    ...
    .detail-grid { display:grid; grid-template-columns:1fr 1fr; gap:1.25rem; max-width:860px; }
...
<div class="cj-page">
    ...
    <main class="cj-main">
        <div class="page-header">
            ...
            <h1 class="page-title">Detalle del <span>Servicio</span></h1>
        </div>

        <div class="detail-grid">
            {{-- Servicio --}}
            <div class="detail-card">
                <p class="detail-card-title">Información del trabajo</p>
                <div class="info-row">
            ...
            {{-- Ubicación --}}
            <div class="detail-card">
                <p class="detail-card-title">Ubicación del servicio</p>
            ...
            <div class="detail-card full">
                <p class="detail-card-title">Datos del cliente</p>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:.25rem">
                    ...
                    @if($contratacion->cliente->telefono_fijo)
                        <div class="info-row">
                            ...
                            <span class="info-value">{{ $contratacion->cliente->telefono_fijo }}</span>
                        </div>
                    @endif
                    <div class="info-row">
                    ...
                    @if($contratacion->cliente->referencias)
                        <div class="info-row">
                            ...
                            <span class="info-value">{{ $contratacion->cliente->referencias }}</span>
                        </div>
                    @endif
                </div>
            </div>
