...
<style>
    ...
    .form-section-title { font-family:'Syne',sans-serif; font-size:.8rem; font-weight:700; color:var(--text-muted); text-transform:uppercase; letter-spacing:1px; margin-bottom:1.1rem; padding-bottom:.6rem; border-bottom:1px solid var(--border); }
    ...
    .form-group select:focus { border-color:var(--cyan); box-shadow:0 0 0 3px rgba(0,195,255,.1); }
    ...
    .btn-submit { background:var(--cyan); color:var(--navy); padding:.75rem 2rem; border-radius:.65rem; font-family:'Syne',sans-serif; font-weight:700; font-size:.95rem; border:none; cursor:pointer; transition:all .2s; box-shadow:0 4px 20px rgba(0,195,255,.25); }
    .btn-submit:hover { background:var(--cyan-dim); transform:translateY(-2px); }
    .btn-cancel { background:transparent; color:var(--text-muted); padding:.75rem 1.5rem; border-radius:.65rem; border:1px solid var(--border); font-weight:600; font-size:.9rem; text-decoration:none; transition:all .2s; }
...
<div class="cj-page">
    <aside class="cj-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('trabajador.editarPerfil') }}" class="active">
    ...
    <main class="cj-main">
        ...
        <div class="page-header">
            ...
            <p class="page-sub">Actualiza tu información profesional</p>
        </div>
        ...
        <div class="form-card">
            <form action="{{ route('trabajador.actualizarPerfil') }}" method="POST">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Nombres</label>
                            <input type="text" name="nombres" value="{{ old('nombres', $profesionista->nombres) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="apellido_p" value="{{ old('apellido_p', $profesionista->apellido_p) }}" required>
                        </div>
                        <div class="form-group">
                            <label>Apellido Materno</label>
                            <input type="text" name="apellido_m" value="{{ old('apellido_m', $profesionista->apellido_m) }}">
                        </div>
                    </div>
                </div>

                <div class="form-section">
                    <p class="form-section-title">Contacto y domicilio</p>
                    <div class="form-grid">
                        <div class="form-group">
                            <label>Teléfono</label>
                            <input type="text" name="telefono" value="{{ old('telefono', $profesionista->telefono) }}" required>
                        </div>
                        <div class="form-group">
                            <label>Código Postal</label>
                            <input type="number" name="cp" value="{{ old('cp', $profesionista->cp) }}" required>
                        </div>
                        <div class="form-group form-full">
                            <label>Domicilio</label>
                            <input type="text" name="domicilio" value="{{ old('domicilio', $profesionista->domicilio) }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="nivel_estudios" value="{{ old('nivel_estudios', $profesionista->nivel_estudios) }}" required>
                        </div>
                        <div class="form-group">
                            <label>Especialidad</label>
                            <input type="text" name="especializado" value="{{ old('especializado', $profesionista->especializado) }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('trabajador.dashboard') }}" class="btn-cancel">Cancelar</a>
                </div>
            </form>
        </div>
    </main>
